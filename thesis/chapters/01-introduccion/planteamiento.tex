...
a pesar de sus ventajas como estándar de interoperabilidad, el mecanismo
convencional de \textit{tool calling} sobre MCP presenta limitaciones
estructurales que comprometen su escalabilidad en aplicaciones de producción
...
del modelo \textit{antes} de que este procese la solicitud del usuario. Esto
...
encomendada. \citet{anthropic2024codeexec} señalan que, con 150,000 tokens de
definiciones de herramientas, los agentes desperdician contexto significativo en
...
completa de una llamada fluye por el contexto dos veces; para una reunión de
ventas de dos horas, esto podría significar procesar 50,000 tokens adicionales
...
de transcripción--- comparten una raíz común: el \textbf{acoplamiento entre la
...
\citet{anthropic2024codeexec} proponen como alternativa la ejecución de código,
...
niveles de complejidad y configuraciones de servidores.
...
directas en términos de consumo de tokens, latencia y precisión, y cómo se
pueden predecir estas condiciones a partir de las características de la tarea?}
