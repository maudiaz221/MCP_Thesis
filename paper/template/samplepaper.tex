...
%
\author{Mauricio D\'iaz Villarreal\inst{1}\orcidID{0000-0000-0000-0000} \and
Jorge Esteban Ram\'irez Shashida\inst{1}\orcidID{0000-0000-0000-0000}}
%
...
sola interacci\'on--- se ha convertido en el recurso m\'as valioso y escaso en
aplicaciones de producci\'on. Cada token consumido representa un costo econ\'omico
directo, una contribuci\'on a la latencia de respuesta y una porci\'on del
espacio disponible para informaci\'on relevante.

Este problema se intensifica con la adopci\'on de \textbf{sistemas ag\'enticos},
en los cuales un LLM interact\'ua con herramientas externas ---bases de datos,
APIs, sistemas de archivos--- para completar tareas del mundo real. El mecanismo
...
y contin\'ua su razonamiento. Este proceso consume tokens en cada paso: las
...
herramientas mediante una interfaz cliente-servidor basada en JSON-RPC. MCP
permite a los modelos descubrir e invocar herramientas de manera uniforme,
independientemente de su implementaci\'on subyacente, y ha sido adoptado
r\'apidamente por la industria como est\'andar de facto.

Dentro del ecosistema MCP han emergido dos paradigmas para la ejecuci\'on de
...
Ambos esquemas resuelven el mismo problema funcional ---conectar un LLM con
herramientas externas--- pero difieren radicalmente en c\'omo utilizan la
...
El mecanismo convencional de tool calling sobre MCP presenta tres limitaciones
...
La tercera es la \textbf{propensi\'on a errores de transcripci\'on}: cuando el
modelo copia datos de la respuesta de una herramienta hacia los par\'ametros de
la siguiente, la probabilidad de error aumenta con el volumen y complejidad de
los datos~\cite{ref_codeexec}.

Estos tres problemas comparten una ra\'iz com\'un: el \textbf{acoplamiento entre
...
% TODO: Write 2nd - MCP protocol, code execution, multi-agent, related work
...
% TODO: Write 1st (most concrete) - factorial matrix, tasks, servers, metrics
